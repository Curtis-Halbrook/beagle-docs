...
Latest Beagle iOS version: [![badge](https://img.shields.io/cocoapods/v/Beagle)](https://cocoapods.org/pods/Beagle)

The following tutorial is for Beagle iOS version: {{<param ios_current_version>}}
...
If you want to skip these configurations, use Beagle's support library: [**Beagle Scaffold**]({{< ref path="/ios/libs/beagle-scaffold" lang="en" >}}), that contains default implementations of Network and Log layers. 
